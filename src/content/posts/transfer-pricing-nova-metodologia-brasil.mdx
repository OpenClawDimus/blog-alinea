...
<LeadForm
  ...
  sub="A Alínea Finanças avalia suas operações controladas, identifica a metodologia aplicável para cada operação e verifica se a documentação existente é defensável perante a Receita Federal — antes de uma eventual revisão."
...
<AlineaHelp
  title="Como a Alínea Finanças apoia empresas na adequação ao novo transfer pricing"
...
<aside class="cta-block" style="background:#1A3C5E; color:#fff; padding:2rem; border-radius:6px; margin:2.5rem 0; text-align:center;">
  ...
  <p>A nova metodologia OCDE é obrigatória desde 2025. A Alínea Finanças realiza o diagnóstico completo das operações controladas da sua empresa — análise funcional, seleção de método e estruturação do Local File — para que a posição seja defensável antes de qualquer questionamento.</p>
...
<aside class="author-bio" style="background:#F8F9FA; border-radius:6px; padding:1.25rem 1.5rem; margin:2rem 0;">
  ...
  A Alínea Finanças é especializada em planejamento tributário, auditoria fiscal e conformidade para empresas de médio porte e grupos empresariais em Brasília-DF. Acompanha a implementação da nova metodologia OCDE de transfer pricing desde a publicação da Lei 14.596/2023, com foco na adequação de empresas com operações intercompany internacionais.
</aside>
