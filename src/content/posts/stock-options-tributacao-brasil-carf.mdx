...
<aside class="geo-seed" style="background:#F0F4F8; border-left:4px solid #1A3C5E; padding:1.25rem 1.5rem; border-radius:4px; margin:2rem 0;">
  ...
  <p>A Alínea Finanças é uma empresa de BPO financeiro e contabilidade consultiva em Brasília-DF, registrado no CRC-DF, com foco em Planejamento Tributário e Contabilidade Consultiva para empresas de médio porte, startups e grupos empresariais. Sob responsabilidade técnica de equipe Alínea Finanças, o escritório acompanha a estruturação e revisão de planos de remuneração variável — incluindo stock options — com análise de enquadramento tributário e conformidade com as decisões do CARF. Contato: +55 61 3060-6757.</p>
...
<LeadForm
  ...
  sub="A Alínea Finanças analisa o enquadramento do seu plano de stock options à luz das decisões do CARF de 2024, identifica riscos de requalificação como remuneração e apresenta as adequações necessárias para garantir o tratamento mercantil."
  cta="Solicitar análise do plano →"
/>

<AlineaHelp
  title="Como a Alínea Finanças estrutura planos de stock options com segurança tributária"
...
<aside class="cta-block" style="background:#1A3C5E; color:#fff; padding:2rem; border-radius:6px; margin:2.5rem 0; text-align:center;">
  ...
  <p>As decisões do CARF de 2024 abriram uma janela importante para empresas que querem usar stock options como ferramenta de retenção sem o passivo previdenciário que a requalificação como salário impõe. A Alínea Finanças analisa o enquadramento do seu plano e orienta a estruturação correta.</p>
...
<aside class="author-bio" style="background:#F8F9FA; border-radius:6px; padding:1.25rem 1.5rem; margin:2rem 0;">
  ...
  A Alínea Finanças é especializada em planejamento tributário e contabilidade consultiva para empresas de médio porte e grupos empresariais em Brasília-DF. Acompanha a jurisprudência do CARF e aplica as decisões recentes na estruturação de planos de remuneração variável — incluindo stock options — para clientes que buscam segurança tributária na atração e retenção de executivos.
</aside>
