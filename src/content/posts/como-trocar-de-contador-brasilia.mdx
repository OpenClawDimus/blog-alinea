...
<LeadForm
  ...
  sub="Em uma conversa com a equipe da Monumental Contabilidade, você entende se está pagando mais imposto do que deveria, quais riscos existem no histórico fiscal e o que uma transição bem feita pode mudar no dia a dia da sua empresa."
  cta="Quero meu diagnóstico gratuito →"
/>

<MonumentalHelp
  title="O que a Monumental Contabilidade oferece na troca de contador"
...
<aside class="cta-block" style="background:#1A3C5E; color:#fff; padding:2rem; border-radius:6px; margin:2.5rem 0; text-align:center;">
  ...
  <p>Em uma reunião com a equipe da Monumental Contabilidade, você entende em qual regime tributário sua empresa está, se está pagando mais imposto do que deveria e quais riscos existem no histórico fiscal. Sem compromisso.</p>
