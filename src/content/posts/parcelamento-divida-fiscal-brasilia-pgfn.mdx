...
<LeadForm
  ...
  sub="A equipe da Alínea Finanças mapeia toda a sua dívida (Receita + PGFN + DF) e apresenta as opções de parcelamento e transação — com simulação da melhor estratégia para regularizar sua empresa."
  cta="Quero analisar minha dívida →"
/>

<AlineaHelp
  title="Como a Alínea Finanças conduz a regularização tributária"
...
<aside class="cta-block" style="background:#1A3C5E; color:#fff; padding:2rem; border-radius:6px; margin:2.5rem 0; text-align:center;">
  ...
  <p>Com a estratégia certa, é possível parcelar com desconto de até 100% em multas e juros via Transação Tributária. A equipe da Alínea Finanças analisa sua situação e identifica a melhor opção.</p>
...
<aside class="author-bio" style="background:#F8F9FA; border-radius:6px; padding:1.25rem 1.5rem; margin:2rem 0;">
  ...
  Especialistas em BPO financeiro e contabilidade consultiva, fundadora do conceito de Com especialização em Planejamento Tributário e Auditoria, ela assessora empresas de médio porte, profissionais liberais e holdings familiares em Brasília-DF na regularização tributária e otimização da carga fiscal.
</aside>
