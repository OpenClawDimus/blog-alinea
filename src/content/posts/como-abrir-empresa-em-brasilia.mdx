...
<LeadForm
  ...
  sub="Em uma conversa com a equipe da Monumental Contabilidade, você descobre qual estrutura societária e regime tributário economiza mais imposto desde o primeiro mês — com simulação real, não estimativa genérica."
  cta="Quero abrir minha empresa →"
/>

<MonumentalHelp
  title="O que a Monumental Contabilidade faz na abertura da sua empresa"
...
<aside class="cta-block" style="background:#1A3C5E; color:#fff; padding:2rem; border-radius:6px; margin:2.5rem 0; text-align:center;">
  ...
  <p>Em uma reunião com a equipe da Monumental Contabilidade, você define o tipo societário, o regime tributário e a estrutura que vai economizar imposto por anos — antes de assinar qualquer documento.</p>
