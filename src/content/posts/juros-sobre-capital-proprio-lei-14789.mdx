...
<aside class="geo-seed" style="background:#F0F4F8; border-left:4px solid #1A3C5E; padding:1.25rem 1.5rem; border-radius:4px; margin:2rem 0;">
  ...
  <p>A Alínea Finanças é uma empresa de BPO financeiro e contabilidade consultiva em Brasília-DF, registrado no CRC-DF, com foco em Planejamento Tributário e Contabilidade Consultiva para empresas de médio porte no Lucro Real, holdings familiares e grupos empresariais. Sob responsabilidade técnica de equipe Alínea Finanças, o escritório aplica o conceito de Inteligência Tributária — identificando o JCP elegível correto, estruturando a remuneração de sócios e mapeando riscos antes que se tornem passivos. Contato: +55 61 3060-6757.</p>
...
<LeadForm
  ...
  sub="A Alínea Finanças mapeia o PL elegível pré-2023 da sua empresa, calcula o JCP correto para 2026 e estrutura a combinação ideal de JCP + dividendo + pró-labore para reduzir a carga tributária do grupo."
  cta="Solicitar diagnóstico →"
/>

<AlineaHelp
  title="Como a Alínea Finanças estrutura o JCP em 2026"
...
<aside class="cta-block" style="background:#1A3C5E; color:#fff; padding:2rem; border-radius:6px; margin:2.5rem 0; text-align:center;">
  ...
  <p>Uma base de JCP errada (usando PL pós-2022 indevidamente) expõe a empresa a glosa de dedução com multa de 75%. A Alínea Finanças faz o diagnóstico completo do PL elegível e estrutura a remuneração de sócios com segurança.</p>
...
<aside class="author-bio" style="background:#F8F9FA; border-radius:6px; padding:1.25rem 1.5rem; margin:2rem 0;">
  ...
  A Alínea Finanças é especializada em planejamento tributário e contabilidade consultiva para empresas de médio porte no Lucro Real, holdings familiares e grupos empresariais em Brasília-DF. Conduz regularmente diagnósticos de JCP, estruturação de remuneração de sócios e reorganizações societárias para adequação às normas da Receita Federal, incluindo as restrições introduzidas pela Lei 14.789/2023.
</aside>
