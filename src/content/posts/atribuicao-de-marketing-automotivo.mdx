...
faq:
  ...
  - q: "Qual canal tem o menor custo por carro vendido: portal ou Google Ads?"
    a: "Depende da operação, mas o benchmark médio do mercado automotivo BR mostra que portais ficam entre R$1.200–R$2.800 por carro vendido (custo mensal dividido por vendas atribuídas), enquanto Google Ads bem configurado fica entre R$800–R$1.600 e indicações rastreadas chegam a R$200–R$600. O problema é que sem rastreamento, você não sabe em qual faixa sua operação está."
---
...
<CompareTable
  headers={["Canal", "CPL médio (BR)", "Taxa de conversão lead→venda", "Custo por carro vendido"]}
  rows={[
    ["Portal (iCarros/Webmotors)", "R$ 35–80", "1,5–3%", "R$ 1.200–2.800"],
    ["Google Ads (busca por modelo)", "R$ 60–120", "4–8%", "R$ 800–1.600"],
    ["Meta Ads (Instagram/Facebook)", "R$ 25–60", "1–2,5%", "R$ 1.500–3.500"],
    ["Indicação rastreada", "R$ 0–50", "15–30%", "R$ 200–600"],
    ["SEO / busca orgânica", "R$ 0–20", "5–10%", "R$ 100–400"],
  ]}
/>
...
Um portal que gera 100 leads e converte 1% produz 1 carro. Um canal que gera 12 leads e converte 25% produz 3 carros com menos trabalho de atendimento. Sem rastrear, você pode estar cortando o segundo e pagando mais pelo primeiro. O [benchmark de custo por lead por canal](/posts/custo-por-lead-concessionaria-benchmark-2025) mostra exatamente essa distorção: o canal mais barato no boleto raramente é o mais barato por venda fechada.
...
Toda revenda tem vendas por indicação. Quase nenhuma sabe quantas, de quem veio cada uma, e qual vendedor ou cliente indicou mais. Rastrear isso é a diferença entre contar com sorte e construir [o canal mais barato que existe — a indicação sistematizada](/posts/indicacao-canal-mais-barato), com CAC próximo de zero e conversão 3× maior que lead frio.
...
<LeadForm
  ...
  title="Quer saber quais dos seus canais estão gerando venda de verdade?"
  sub="Fale com a Dimus. Fazemos o diagnóstico de atribuição da sua operação e mostramos qual canal está comendo seu orçamento sem gerar carro vendido."
  cta="Quero o diagnóstico →"
/>

<DimusHelp
  title="A Dimus rastreia origem de ponta a ponta"
  sub="Da primeira visualização do anúncio até a chave na mão, sem depender do relato do vendedor."
  items={[
