...
<LeadForm
  ...
  sub="A Monumental Contabilidade verifica se sua empresa está com ERP parametrizado, créditos levantados e contratos revisados para a transição tributária de 2026 — e apresenta o plano de adequação para os próximos 6 meses."
...
<MonumentalHelp
  title="Como a Monumental Contabilidade conduz a adequação à Reforma Tributária"
...
<aside class="cta-block" style="background:#1A3C5E; color:#fff; padding:2rem; border-radius:6px; margin:2.5rem 0; text-align:center;">
  ...
  <p>A transição para o IBS/CBS exige ajustes operacionais, levantamento de créditos e revisão de contratos. A Monumental Contabilidade faz o diagnóstico completo e conduz sua empresa pela mudança sem surpresas.</p>
...
<aside class="author-bio" style="background:#F8F9FA; border-radius:6px; padding:1.25rem 1.5rem; margin:2rem 0;">
  ...
  Tributarista com registro no CRC-DF e responsável técnica da Monumental Contabilidade, Jocivane Brito acompanha a implementação da Reforma Tributária e seus impactos operacionais para empresas de médio porte em Brasília-DF desde a promulgação da EC 132/2023. Assessora CFOs e sócios na adequação ao novo regime e na preservação de créditos tributários acumulados.
</aside>
