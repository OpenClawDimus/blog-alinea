...
<LeadForm
  ...
  sub="A equipe da Monumental Contabilidade revisa os pontos críticos da sua holding — dividendos, aluguel intragrupo, escrituração e obrigações acessórias — e entrega um relatório de conformidade sem compromisso."
...
<MonumentalHelp
  title="Como a Monumental Contabilidade garante a conformidade da sua holding em 2026"
...
<aside class="cta-block" style="background:#1A3C5E; color:#fff; padding:2rem; border-radius:6px; margin:2.5rem 0; text-align:center;">
  ...
  <p>Em uma reunião com Jocivane Brito (tributarista CRC-DF), você recebe um diagnóstico de conformidade completo — dividendos, aluguel intragrupo, escrituração e obrigações acessórias — com orientações práticas para regularizar o que estiver pendente.</p>
