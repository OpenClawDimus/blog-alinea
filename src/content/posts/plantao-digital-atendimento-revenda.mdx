...
<LeadForm
  id="blog-plantao-digital-form"
  title="Quer montar o plantão digital da sua revenda?"
  sub="A Dimus estrutura a escala, treina a equipe e configura a visibilidade em tempo real — sem precisar contratar mais vendedores."
  cta="Quero estruturar o plantão →"
/>
