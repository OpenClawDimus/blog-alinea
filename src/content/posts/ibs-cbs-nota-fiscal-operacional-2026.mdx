...
<MonumentalHelp
  title="Adequação à Reforma Tributária — como a Monumental pode ajudar"
  items={[
...
<aside class="cta-block" style="background:#1A3C5E; color:#fff; padding:2rem; border-radius:6px; margin:2.5rem 0; text-align:center;">
  ...
  <p>A Monumental Contabilidade verifica se seu ERP está parametrizado corretamente e mapeia os itens por cClassTrib — antes que a SEFAZ rejeite suas notas.</p>
...
<aside class="author-bio" style="background:#F7F9FC; border:1px solid #E2E8F0; padding:1.5rem; border-radius:6px; margin:2rem 0; display:flex; gap:1rem; align-items:flex-start;">
  <div>
    <strong style="display:block; font-size:1.05rem;">Jocivane Brito</strong>
    <span style="color:#64748B; font-size:0.9rem;">Tributarista | CRC-DF</span>
    <p style="margin:0.5rem 0 0; font-size:0.95rem; color:#374151;">Especialista em Planejamento Tributário e Reforma Tributária, Jocivane Brito acompanha de perto a implementação da LC 214/2025 e assessora empresas de médio porte no Distrito Federal na adequação ao novo regime de IBS e CBS. Atua na Monumental Contabilidade com foco em auditoria fiscal e consultoria estratégica para CFOs e sócios.</p>
  </div>
</aside>
