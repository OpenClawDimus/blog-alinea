...
coverImage: /covers/image_0_dark_cin_20260715_133518.jpg
tags:
  - "automotivo-metricas"
  - "gestao"
  - "conversao"
...
<CompareTable
  ...
  caption="Benchmarks estimados para revendas de seminovos no Brasil com processo mínimo estruturado. Fontes: HBR/Oldroyd (contato), Leadster 2024 (resposta), benchmarks Rework.com (automotivo BR)."
/>
...
Um estudo com 100.000 leads reais de empresas americanas (Oldroyd, McElheran, Elkington, Curran — Harvard Business Review, 2011) identificou que empresas que contatam o lead em até 5 minutos têm 100x mais chance de contato efetivo do que as que esperam 30 minutos. A janela não é um número de atendimento ao cliente — é uma janela de atenção do comprador que está, naquele momento, com o celular na mão e o portal aberto.
...
<CompareTable
  ...
  caption="Comparativo estimado de métricas de funil entre revendas de seminovos sem processo estruturado e top performers com processo. Fontes: Leadster 2024, Rework.com, benchmarks de campo Dimus."
/>
...
O funil de vendas automotivo é um sistema com cinco entradas mensuráveis e cinco taxas de conversão rastreáveis. Você não precisa melhorar tudo ao mesmo tempo. Precisa identificar qual etapa está com a maior perda relativa — e começar por ela. Na maioria das revendas que passamos pelo diagnóstico, a resposta é a mesma: o contato efetivo, na janela dos primeiros cinco minutos.
...
<LeadForm
  id="blog-funil-automotivo-form"
  title="Qual é a sua taxa de conversão hoje?"
  sub="Manda seu contato. Em 30 minutos a gente estima onde está o seu gargalo de funil — sem precisar de CRM, só com os dados que você já tem."
  cta="Quero o diagnóstico de funil →"
/>
