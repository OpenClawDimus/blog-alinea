...
<LeadForm
  ...
  sub="A Alínea Finanças mapeia as controladas e coligadas no exterior, calcula a carga tributária efetiva após créditos, e estrutura o processo de declaração na ECF — garantindo conformidade e evitando autuações por omissão ou apuração incorreta."
...
<aside class="author-bio" style="background:#F8F9FA; border-radius:6px; padding:1.25rem 1.5rem; margin:2rem 0;">
  ...
  A Alínea Finanças é especializada em planejamento tributário internacional e auditoria fiscal para empresas de médio porte e grupos empresariais com operações no exterior. Conduz regularmente análises de adequação à Lei 14.754/2023 e reorganizações de estruturas internacionais para clientes em Brasília-DF.
</aside>
